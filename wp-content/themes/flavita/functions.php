...
if (isset($_POST['submitbtn'])) {
	$data = array(
		...
		'modeof_procurement' => $_POST['modeof_procurement'],
		'bid_closingdate' => $_POST['bid_closingdate'],
		'bid_closingtime' => $_POST['bid_closingtime'],
		'public_body' => $_POST['public_body'] ,
	);
	$table_name = 'call_for_tender';
	$result = $pppda->insert($table_name, $data, $format=NULL);
	if ($result==1) {
		echo "<script>alert('Call for tender is saved');</script>";
	}
	else
	{
